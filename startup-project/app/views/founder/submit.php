    ...
    <div class="main">
        ...
        <div class="form-container">
            <div class="form-header">
                <h2>Submit a New Founder</h2>
                <p>Fill out the form below to add a founder to our directory</p>
            </div>
            <form id="founder-form" method="POST">
                <div class="form-group">
                    <label for="name">Full Name</label>
                    <input type="text" id="name" name="name" required class="form-control" placeholder="Enter full name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="bio" name="bio" required class="form-control" placeholder="Write a brief biography"></textarea>
                </div>
                <div class="form-actions">
                    <button type="submit" class="btn-submit">Submit Founder</button>
                </div>
            </form>
        </div>
    </div>
